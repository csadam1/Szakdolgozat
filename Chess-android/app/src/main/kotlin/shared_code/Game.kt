...
class Game(_player1: Player, _player2: Player) {
     ...
     * If white is to shared_code.move and Player1 is white, then Player1 will be the current player.
     * If black is to shared_code.move and Player1 is black, then Player1 will be the current player.
